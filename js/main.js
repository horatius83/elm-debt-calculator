...
{
	if (region.at.L === region.aG.L)
	{
		return 'on line ' + region.at.L;
	}
	return 'on lines ' + region.at.L + ' through ' + region.aG.L;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aI: fragment, aM: host, aV: path, aY: port_, a$: protocol, a0: query};
	});
...
var $author$project$NewLoan$emptyLoanForm = {ad: '', aR: '', al: '', ab: ''};
	...
	return _Utils_Tuple2(
		{
			...
			C: 0,
			v: _List_Nil,
			an: $author$project$NewLoan$emptyLoanForm,
			P: $elm$core$Maybe$Nothing,
			a: {q: $elm$core$Maybe$Nothing, Z: '20', M: '', ap: 0},
			S: 0,
			ay: 20
		},
...
var $author$project$State$EmergencyFundPlan = F4(
	function (maxAmount, maxAmountAsString, percentageToApply, percentageToApplyAsString) {
		return {aQ: maxAmount, aj: maxAmountAsString, aW: percentageToApply, aq: percentageToApplyAsString};
	});
...
var $author$project$State$Loan = F4(
	function (name, apr, minimum, principal) {
		return {ad: apr, aR: minimum, al: name, ab: principal};
	});
...
var $author$project$NewLoan$addLoan = function (model) {
	var toLoan = $author$project$State$Loan(model.an.al);
	var principal = $elm$core$String$toFloat(model.an.ab);
	var minimum = $elm$core$String$toFloat(model.an.aR);
	var apr = $elm$core$String$toFloat(model.an.ad);
...
var $author$project$State$PaymentSequence = F4(
	function (loan, actualMinimum, payments, isPaidOff) {
		return {az: actualMinimum, ah: isPaidOff, ai: loan, u: payments};
	});
var $author$project$Loan$addPaymentToPaymentPlan = F2(
	function (pp, ps) {
		var oldPayments = pp.u;
...
var $author$project$Loan$calculateNewPayment = F2(
	function (_v0, _v1) {
		var loan = _v0.ai;
		var actualMinimum = _v0.az;
		var payments = _v0.u;
		var isPaidOff = _v0.ah;
		var bonus = _v1.a;
		...
		var totalAmountPaid = A3(
			...
			0,
			payments);
		var principalRemaining = loan.ab - totalAmountPaid;
...
var $author$project$Loan$getMinimumTotalAmount = function (pp) {
	...
	var f = F2(
		function (ps, totalAmount) {
			return ps.ah ? totalAmount : (totalAmount + ps.az);
		});
...
var $author$project$Loan$strategy = F3(
	function (sortFunction, paymentPlan, maximumAmount) {
		var sortedPaymentPlan = A2($elm$core$List$sortBy, sortFunction, paymentPlan.u);
			...
			if (!_v2.$) {
				...
				var savingsAmount = function () {
					var totalPaidIntoEmergencyFund = A3(
						...
						0,
						efp.u);
					return (_Utils_cmp(totalPaidIntoEmergencyFund, efp.aa.aQ) < 0) ? ((maximumAmount - minimumTotalPayment) * inv(efp.aa.aW)) : 0;
				}();
		...
		var bonusAmount = function () {
			...
			if (!_v1.$) {
				...
				var totalPaidIntoEmergencyFund = A3(
					...
					0,
					efp.u);
				return (_Utils_cmp(totalPaidIntoEmergencyFund, efp.aa.aQ) < 0) ? ((maximumAmount - minimumTotalPayment) * inv(efp.aa.aW)) : (maximumAmount - minimumTotalPayment);
			} else {
...
var $author$project$Loan$avalanche = $author$project$Loan$strategy(
	function (paymentSequence) {
		return (-1.0) * paymentSequence.ai.ad;
	});
...
var $author$project$Loan$snowball = $author$project$Loan$strategy(
	function (paymentSequence) {
		return (-1.0) * paymentSequence.ai.ab;
	});
...
var $author$project$Loan$toPaymentPlan = F2(
	function (maxNumberOfYears, loans) {
		var calculatedMinimum = function (loan) {
			return A3($author$project$Loan$getMinimumPaymentAmount, loan.ab, loan.ad, maxNumberOfYears);
		};
		var getActualMinimum = function (loan) {
			var cm = calculatedMinimum(loan);
			return (_Utils_cmp(cm, loan.aR) < 0) ? loan.aR : cm;
		};
		var payments = A2(
			$elm$core$List$map,
			function (ln) {
...
var $author$project$Main$generatePaymentPlan = function (model) {
	...
	while (true) {
		var newPaymentPlan = function () {
			var _v9 = model.P;
			if (_v9.$ === 1) {
				return A2($author$project$Loan$toPaymentPlan, model.ay, model.v);
			} else {
				var x = _v9.a;
				return x;
			}
		...
		var paymentPlanResult = function () {
			var _v8 = model.a.ap;
			if (!_v8) {
				return A2($author$project$Loan$avalanche, newPaymentPlan, model.S);
			} else {
				return A2($author$project$Loan$snowball, newPaymentPlan, model.S);
			}
		}();
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							P: $elm$core$Maybe$Just(paymentPlan)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var paymentPlan = paymentPlanResult.a;
		...
		switch (msg.$) {
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{v: loans, an: $author$project$NewLoan$emptyLoanForm}),
					$elm$core$Platform$Cmd$none);
			case 1:
			...
			case 7:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							X: A2($elm$core$List$cons, errorMessage, model.X)
						}),
					...
					function (time, timeZone) {
						return $author$project$Main$generatePaymentPlan(
							_Utils_update(
								model,
								{
									V: $elm$core$Maybe$Just(time),
									W: $elm$core$Maybe$Just(timeZone),
									C: 2
								}));
					});
				return _Utils_Tuple2(
			...
			case 16:
				var formState = msg.a;
				var sf = model.a;
				var paymentPlan = A2($author$project$Loan$toPaymentPlan, model.ay, model.v);
						...
						_Utils_update(
							model,
							{
								...
								a: _Utils_update(
									sf,
									{
										M: $elm$core$String$fromFloat(totalMinimumAmount)
									}),
								S: totalMinimumAmount
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
...
var $author$project$Main$viewLoan = F2(
	function (index, loan) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$Main$viewTextInput, 'Name', loan.al, 'new-loan-name', $author$project$State$UpdateLoanName),
						A4($author$project$Main$viewTextInput, 'Principal', loan.ab, 'new-loan-principal', $author$project$State$UpdateLoanPrincipal),
						A4($author$project$Main$viewTextInput, 'Minimum', loan.aR, 'new-loan-minimum', $author$project$State$UpdateLoanMinimum),
						A4($author$project$Main$viewTextInput, 'APR', loan.ad, 'new-loan-apr', $author$project$State$UpdateLoanApr),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
...
var $author$project$Main$viewPaymentSequence = F3(
	function (currentYear, currentMonth, paymentSequence) {
			...
			function (ps, acc) {
				...
				if (!_v3.b) {
					...
					return A2(
						...
						_List_fromArray(
							[
								A4($author$project$State$PaymentSequence, ps.ai, ps.az, xs, ps.ah)
							]));
				}
			});
		...
		if (!thisMonthsPayments.b) {
			...
			return A2(
				...
				thisSection,
				A3(
					$author$project$Main$viewPaymentSequence,
...
var $author$project$Main$viewPaymentPlan = F3(
	function (currentYear, currentMonth, paymentPlan) {
		var payments = A3($author$project$Main$viewPaymentSequence, currentYear, currentMonth, paymentPlan);
...
var $author$project$Main$viewCheckboxInput = F4(
...
var $author$project$Main$viewPaymentStrategy = function (model) {
	...
	var isCalculatePaymentPlanButtonDisabled = function () {
		var maxTotalPayment = $elm$core$String$toFloat(model.a.M);
		var maxNumberOfYears = $elm$core$String$toFloat(model.a.Z);
		var hasLoans = $elm$core$List$length(model.v) > 0;
	...
	var emergencyFundFields = function () {
		...
		if (!_v1.$) {
			...
			return _List_fromArray(
				[
					A4($author$project$Main$viewTextInput, 'Maximum Emergency Fund Amount', ef.aj, 'max-emergency-fund-amount', $author$project$State$UpdateEmergencyFundMaxAmount),
					A4($author$project$Main$viewTextInput, 'Percentage of Bonus Funds to Apply', ef.aq, 'percentage-to-apply', $author$project$State$UpdateEmergencyFundPercentage)
				]);
		} else {
			return _List_Nil;
		}
	...
	var strategyFields = _List_fromArray(
		[
			A4($author$project$Main$viewTextInput, 'Maximum number of years to payoff', model.a.Z, 'years-to-payoff', $author$project$State$UpdateYearsToPayoff),
			A4($author$project$Main$viewTextInput, 'Maximum total monthly payment', model.a.M, 'total-minimum-amount', $author$project$State$UpdateMaximumTotalPayment),
			A4($author$project$Main$viewSelect, 'Payment Strategy', 'payment-strategy', paymentStrategyOptions, optionToStrategy),
			A4($author$project$Main$viewCheckboxInput, 'Build Emergency Fund?', 'has-emergency-fund', displayEmergencyFundOptions, $author$project$State$ToggleHasEmergencyFund)
		]);
...
var $author$project$Main$view = function (model) {
	var title = _List_fromArray(
		[
			$author$project$Main$viewMenu(model.C)
		]);
	...
	var paymentStrategy = A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewPaymentStrategy(model)
			]));
	var paymentPlan = function () {
		var _v1 = _Utils_Tuple3(model.V, model.W, model.P);
		if (((!_v1.a.$) && (!_v1.b.$)) && (!_v1.c.$)) {
			...
			return _List_fromArray(
				[
					A3(
					$author$project$Main$viewPaymentPlan,
	...
	var errors = A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, errorListItem, model.X));
