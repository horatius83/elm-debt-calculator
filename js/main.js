...
{
	if (region.ap.L === region.aC.L)
	{
		return 'on line ' + region.ap.L;
	}
	return 'on lines ' + region.ap.L + ' through ' + region.aC.L;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aE: fragment, aI: host, aU: path, aY: port_, a$: protocol, a0: query};
	});
...
var $author$project$NewLoan$emptyLoanForm = {ab: '', aP: '', aj: '', _: ''};
	...
	return _Utils_Tuple2(
		{
			...
			B: 0,
			D: _List_Nil,
			aR: $author$project$NewLoan$emptyLoanForm,
			O: $elm$core$Maybe$Nothing,
			b: {u: $elm$core$Maybe$Nothing, aO: '20', ah: '', am: 0},
			R: 0,
			au: 20
		},
...
var $author$project$State$EmergencyFundPlan = F4(
	function (maxAmount, maxAmountAsString, percentageToApply, percentageToApplyAsString) {
		return {aM: maxAmount, aN: maxAmountAsString, aV: percentageToApply, aW: percentageToApplyAsString};
	});
...
var $author$project$State$Loan = F4(
	function (name, apr, minimum, principal) {
		return {ab: apr, aP: minimum, aj: name, _: principal};
	});
...
var $author$project$NewLoan$addLoan = function (model) {
	var toLoan = $author$project$State$Loan(model.aR.aj);
	var principal = $elm$core$String$toFloat(model.aR._);
	var minimum = $elm$core$String$toFloat(model.aR.aP);
	var apr = $elm$core$String$toFloat(model.aR.ab);
...
var $author$project$Loan$NoFurtherPaymentsToBeMade = function (a) {
	return {$: 1, a: a};
};
var $author$project$State$PaymentPlan = F2(
	function (payments, savings) {
		return {t: payments, a5: savings};
	});
...
var $author$project$State$PaymentSequence = F4(
	function (loan, actualMinimum, payments, isPaidOff) {
		return {av: actualMinimum, af: isPaidOff, ag: loan, t: payments};
	});
var $author$project$Loan$addPaymentToPaymentPlan = F2(
	function (pp, ps) {
		var oldPayments = pp.t;
		var newPayments = _Utils_ap(
			oldPayments,
			_List_fromArray(
				[ps]));
...
var $author$project$Loan$calculateNewPayment = F2(
	function (_v0, _v1) {
		var loan = _v0.ag;
		var actualMinimum = _v0.av;
		var payments = _v0.t;
		var isPaidOff = _v0.af;
		var bonus = _v1.a;
		...
		var totalAmountPaid = A3(
			...
			0,
			payments);
		var principalRemaining = loan._ - totalAmountPaid;
		var minimumAndBonus = actualMinimum + bonus;
		return isPaidOff ? _Utils_Tuple2(
			bonus,
			A2(
				$author$project$Loan$addPaymentToPaymentPlan,
				newPaymentSequence,
				A4($author$project$State$PaymentSequence, loan, actualMinimum, payments, true))) : ((_Utils_cmp(principalRemaining, minimumAndBonus) < 0) ? _Utils_Tuple2(
			minimumAndBonus - principalRemaining,
			A2(
				$author$project$Loan$addPaymentToPaymentPlan,
				newPaymentSequence,
				A4(
					$author$project$State$PaymentSequence,
					loan,
					actualMinimum,
					_Utils_ap(
						payments,
...
var $author$project$Loan$getMinimumTotalAmount = function (pp) {
	var payments = pp.t;
	var f = F2(
		function (ps, totalAmount) {
			return ps.af ? totalAmount : (totalAmount + ps.av);
		});
	return A3($elm$core$List$foldl, f, 0, payments);
};
var $elm$core$Basics$not = _Basics_not;
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$Loan$strategy = F3(
	function (sortFunction, paymentPlan, maximumAmount) {
		var sortedPaymentPlan = A2($elm$core$List$sortBy, sortFunction, paymentPlan.t);
		var minimumTotalPayment = $author$project$Loan$getMinimumTotalAmount(paymentPlan);
		var inv = function (x) {
			return 1.0 - x;
		};
		var emptyPp = function () {
			var _v2 = paymentPlan.a5;
			if (!_v2.$) {
				var efp = _v2.a;
				var savingsAmount = function () {
					var totalPaidIntoEmergencyFund = A3(
						$elm$core$List$foldl,
						F2(
							function (acc, x) {
								return acc + x;
						...
						0,
						efp.t);
					return (_Utils_cmp(totalPaidIntoEmergencyFund, efp.Z.aM) < 0) ? ((maximumAmount - minimumTotalPayment) * inv(efp.Z.aV)) : 0;
				}();
				...
				return A2(
					$author$project$State$PaymentPlan,
					_List_Nil,
					$elm$core$Maybe$Just(newEfpPlans));
			} else {
				return A2($author$project$State$PaymentPlan, _List_Nil, $elm$core$Maybe$Nothing);
			}
		}();
		var bonusAmount = function () {
			var _v1 = paymentPlan.a5;
			if (!_v1.$) {
				var efp = _v1.a;
				var totalPaidIntoEmergencyFund = A3(
					$elm$core$List$foldl,
					...
					0,
					efp.t);
				return (_Utils_cmp(totalPaidIntoEmergencyFund, efp.Z.aM) < 0) ? ((maximumAmount - minimumTotalPayment) * inv(efp.Z.aV)) : (maximumAmount - minimumTotalPayment);
			} else {
		...
		var _v0 = A3(
			...
			_Utils_Tuple2(bonusAmount, emptyPp),
			sortedPaymentPlan);
...
var $author$project$Loan$avalanche = $author$project$Loan$strategy(
	function (paymentSequence) {
		return (-1.0) * paymentSequence.ag.ab;
	});
...
var $author$project$Loan$toPaymentPlan = F2(
	function (maxNumberOfYears, loans) {
		var calculatedMinimum = function (loan) {
			return A3($author$project$Loan$getMinimumPaymentAmount, loan._, loan.ab, maxNumberOfYears);
		};
		var getActualMinimum = function (loan) {
			var cm = calculatedMinimum(loan);
			return (_Utils_cmp(cm, loan.aP) < 0) ? loan.aP : cm;
		};
		var payments = A2(
			$elm$core$List$map,
			function (ln) {
			...
			loans);
		return A2($author$project$State$PaymentPlan, payments, $elm$core$Maybe$Nothing);
	});
var $author$project$NewLoan$updateNewLoanForm = F2(
	function (f, model) {
		var oldLoanForm = model.aR;
...
var $author$project$Main$generatePaymentPlan = function (model) {
	...
	while (true) {
		var newPaymentPlan = function () {
			var _v9 = model.O;
			if (_v9.$ === 1) {
				return A2($author$project$Loan$toPaymentPlan, model.au, model.D);
			} else {
				var x = _v9.a;
				return x;
			}
		...
		var paymentPlanResult = function () {
			var _v8 = model.b.am;
			if (!_v8) {
				return A2($author$project$Loan$avalanche, newPaymentPlan, model.R);
			} else {
				return A2($author$project$Loan$snowball, newPaymentPlan, model.R);
			}
		}();
			...
			case 1:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							O: $elm$core$Maybe$Just(paymentPlan)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var paymentPlan = paymentPlanResult.a;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 2:
				var index = msg.a;
				var loans = A2($elm_community$list_extra$List$Extra$removeAt, index, model.D);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{D: loans, aR: $author$project$NewLoan$emptyLoanForm}),
					$elm$core$Platform$Cmd$none);
			case 1:
			...
			case 7:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							W: A2($elm$core$List$cons, errorMessage, model.W)
						}),
					...
					function (time, timeZone) {
						return $author$project$Main$generatePaymentPlan(
							_Utils_update(
								model,
								{
									U: $elm$core$Maybe$Just(time),
									V: $elm$core$Maybe$Just(timeZone),
									B: 2
								}));
					});
				return _Utils_Tuple2(
			...
			case 15:
				var f = F2(
					function (time, timeZone) {
						var _v1 = $author$project$Main$generatePaymentPlan(
							_Utils_update(
								model,
								{
									U: $elm$core$Maybe$Just(time),
						...
						var paymentPlanModel = _v1.a;
						return _Utils_Tuple2(
							paymentPlanModel,
							$author$project$PortPdfMake$showAsPdf('placeholder'));
					});
				return _Utils_Tuple2(
					model,
					A2(
			...
			case 13:
				...
				var totalMonthlyPayment = $elm$core$String$toFloat(paymentAsString);
				var form = model.b;
				var newForm = _Utils_update(
					form,
					{ah: paymentAsString});
				if (!totalMonthlyPayment.$) {
					var tmp = totalMonthlyPayment.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{b: newForm, R: tmp}),
			...
			case 16:
				var formState = msg.a;
				var sf = model.b;
				var paymentPlan = A2($author$project$Loan$toPaymentPlan, model.au, model.D);
						...
						_Utils_update(
							model,
							{
								...
								b: _Utils_update(
									sf,
									{
										ah: $elm$core$String$fromFloat(totalMinimumAmount)
									}),
								R: totalMinimumAmount
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
			...
			case 17:
				var sf = model.b;
				var newEmergencyFund = function () {
					var _v4 = model.b.u;
					if (!_v4.$) {
						return $elm$core$Maybe$Nothing;
					} else {
						return $elm$core$Maybe$Just(
							A4($author$project$State$EmergencyFundPlan, 0, '0', 0.5, '50%'));
					}
				}();
			...
			case 18:
				...
				var newEf = A3($elm$core$Maybe$map2, newEmergencyFundPlan, ef, amountN);
...
var $author$project$View$viewLoan = F2(
	function (index, loan) {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('align-right')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$State$DeleteLoan(index))
								]),
							_List_fromArray(
								[
...
var $author$project$State$UpdateLoanMinimum = function (a) {
	return {$: 6, a: a};
};
var $author$project$State$UpdateLoanName = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$View$viewTextInput = F4(
...
var $author$project$View$viewNewLoan = function (model) {
	var loan = model.aR;
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Events$onSubmit($author$project$State$DoNothing)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A4($author$project$View$viewTextInput, 'Name', loan.aj, 'new-loan-name', $author$project$State$UpdateLoanName),
						A4($author$project$View$viewTextInput, 'Principal', loan._, 'new-loan-principal', $author$project$State$UpdateLoanPrincipal),
						A4($author$project$View$viewTextInput, 'Minimum', loan.aP, 'new-loan-minimum', $author$project$State$UpdateLoanMinimum),
						A4($author$project$View$viewTextInput, 'APR', loan.ab, 'new-loan-apr', $author$project$State$UpdateLoanApr),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Save to File')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$State$ResetNewLoan)
							]),
						_List_fromArray(
							[
...
var $author$project$TimeUtil$getNextMonth = function (month) {
	switch (month) {
		case 0:
			return 1;
		case 1:
...
var $author$project$TimeUtil$getNextYear = F2(
	function (year, month) {
		if (month === 11) {
			return year + 1;
		} else {
...
var $author$project$View$viewMoney = function (f) {
...
var $author$project$View$viewPaymentSequence = F3(
	function (currentYear, currentMonth, paymentSequence) {
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$View$viewMoney(amount)
								]))
						]));
			});
		var viewDate = F2(
			function (year, month) {
				var yearAsText = $elm$core$String$fromInt(year);
				var monthAsText = $author$project$TimeUtil$monthToString(month);
				return $elm$html$Html$text(monthAsText + (' ' + yearAsText));
			});
			...
			function (ps, acc) {
				...
				if (!_v3.b) {
					...
					return A2(
						...
						_List_fromArray(
							[
								A4($author$project$State$PaymentSequence, ps.ag, ps.av, xs, ps.af)
							]));
				}
			});
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(viewDate, currentYear, currentMonth)
								]))
						])),
					A2(
					$elm$html$Html$table,
		...
		if (!thisMonthsPayments.b) {
			...
			return A2(
				...
				thisSection,
				A3(
					$author$project$View$viewPaymentSequence,
					A2($author$project$TimeUtil$getNextYear, currentYear, currentMonth),
					$author$project$TimeUtil$getNextMonth(currentMonth),
					nextMonthsPaymentSequence));
		}
	});
var $author$project$View$viewPaymentPlan = F3(
	function (currentYear, currentMonth, paymentPlan) {
		var payments = A3($author$project$View$viewPaymentSequence, currentYear, currentMonth, paymentPlan);
...
var $author$project$State$ToggleHasEmergencyFund = {$: 17};
var $author$project$State$UpdateEmergencyFundMaxAmount = function (a) {
	return {$: 18, a: a};
};
var $author$project$State$UpdateEmergencyFundPercentage = function (a) {
	return {$: 19, a: a};
};
...
var $author$project$View$viewCheckboxInput = F4(
	function (labelText, id, val, callback) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
...
var $author$project$View$viewSelect = F4(
	function (labelText, id, options, stringToMsg) {
...
var $author$project$View$viewPaymentStrategy = function (model) {
	...
	var isCalculatePaymentPlanButtonDisabled = function () {
		var maxTotalPayment = $elm$core$String$toFloat(model.b.ah);
		var maxNumberOfYears = $elm$core$String$toFloat(model.b.aO);
		var hasLoans = $elm$core$List$length(model.D) > 0;
		var _v2 = _Utils_Tuple3(hasLoans, maxNumberOfYears, maxTotalPayment);
	...
	var emergencyFundFields = function () {
		var _v1 = model.b.u;
		if (!_v1.$) {
			var ef = _v1.a;
			return _List_fromArray(
				[
					A4($author$project$View$viewTextInput, 'Maximum Emergency Fund Amount', ef.aN, 'max-emergency-fund-amount', $author$project$State$UpdateEmergencyFundMaxAmount),
					A4($author$project$View$viewTextInput, 'Percentage of Bonus Funds to Apply', ef.aW, 'percentage-to-apply', $author$project$State$UpdateEmergencyFundPercentage)
				]);
		} else {
			return _List_Nil;
		}
	}();
	var displayEmergencyFundOptions = function () {
		var _v0 = model.b.u;
		if (!_v0.$) {
			return true;
		} else {
	...
	var strategyFields = _List_fromArray(
		[
			A4($author$project$View$viewTextInput, 'Maximum number of years to payoff', model.b.aO, 'years-to-payoff', $author$project$State$UpdateYearsToPayoff),
			A4($author$project$View$viewTextInput, 'Maximum total monthly payment', model.b.ah, 'total-minimum-amount', $author$project$State$UpdateMaximumTotalPayment),
			A4($author$project$View$viewSelect, 'Payment Strategy', 'payment-strategy', paymentStrategyOptions, optionToStrategy),
			A4($author$project$View$viewCheckboxInput, 'Build Emergency Fund?', 'has-emergency-fund', displayEmergencyFundOptions, $author$project$State$ToggleHasEmergencyFund)
		]);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					strategyFields,
					_Utils_ap(emergencyFundFields, buttons)))
			]));
};
var $author$project$Main$view = function (model) {
	var title = _List_fromArray(
		[
			$author$project$Main$viewMenu(model.B)
		]);
	var tableRows = A2($elm$core$List$indexedMap, $author$project$View$viewLoan, model.D);
	var paymentStrategy = A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$View$viewPaymentStrategy(model)
			]));
	var paymentPlan = function () {
		var _v1 = _Utils_Tuple3(model.U, model.V, model.O);
		if (((!_v1.a.$) && (!_v1.b.$)) && (!_v1.c.$)) {
			var time = _v1.a.a;
			var timeZone = _v1.b.a;
			var pp = _v1.c.a;
			return _List_fromArray(
				[
					A3(
					$author$project$View$viewPaymentPlan,
	...
	var newLoans = _List_fromArray(
		[
			$author$project$View$viewNewLoan(model)
		]);
	var headRow = A2(
		$elm$html$Html$thead,
		_List_Nil,
	...
	var loans = $elm$core$List$isEmpty(model.D) ? _List_Nil : _List_fromArray(
		[
			A2(
			$elm$html$Html$table,
			_List_Nil,
	...
	var errors = A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2($elm$core$List$map, errorListItem, model.W));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{bx: $author$project$Main$init, bN: $author$project$Main$subscriptions, bR: $author$project$Main$update, bS: $author$project$Main$view});
